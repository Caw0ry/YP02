...
{
    public partial class SellItems : UserControl //определение класса продажи товаров
    {
        List<AbstractItem> itemCart = new List<AbstractItem>(); //определения списка товаров в корзине
